...
data1 = simulate_dataset(n_replicates, cov_width=cov_width)
res1 = perform_dea(1, group)

data2 = simulate_dataset(n_replicates, cov_width=cov_width, cov_strengths=c(strong_effect, strong_effect, 0, weak_effect, 0, 0))
